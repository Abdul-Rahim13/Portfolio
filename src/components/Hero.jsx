...
function Hero() {
  return (
    <div className='flex flex-col items-center bg-[#161513] w-full top-0 left-0 m-0 p-0'>
        ...
        <div className='mt-5'>
            <h1 className='text-4xl font-semibold text-white'><span className='bg-gradient-to-r from-[#DF8908] to-[#B415FF] bg-clip-text text-transparent'>I'am Abdul Rahim,</span> MERN Stack</h1>
