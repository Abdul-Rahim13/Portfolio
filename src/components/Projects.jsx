    ...
    <div id='portfolio' className='bg-[#161513]'>
        ...
        <div className='grid grid-cols-3 gap-x-5 gap-y-5 justify-items-center mt-7'>
            <div className="text-white h-[250px] w-[390px] rounded-2xl border-2 border-white/40 transition duration-400 transform hover:scale-105 hover:border-[#ff00ff] cursor-pointer">
                <img className="w-full h-full object-cover rounded-2xl" src={P1} alt="" />
            </div>

            <div className="text-white h-[250px] w-[390px] rounded-2xl border-2 border-white/40 transition duration-400 transform hover:scale-105 hover:border-[#ff00ff] cursor-pointer">
                <img className="w-full h-full object-cover rounded-2xl" src={P2} alt="" />
            </div>

            <div className="text-white h-[250px] w-[390px] rounded-2xl border-2 border-white/40 transition duration-400 transform hover:scale-105 hover:border-[#ff00ff] cursor-pointer">
                <img className="w-full h-full object-cover rounded-2xl" src={P3} alt="" />
            </div>

            <div className="text-white h-[250px] w-[390px] rounded-2xl border-2 border-white/40 transition duration-400 transform hover:scale-105 hover:border-[#ff00ff] cursor-pointer">
                <img className="w-full h-full object-cover rounded-2xl" src={P4} alt="" />
            </div>

            <div className="text-white h-[250px] w-[390px] rounded-2xl border-2 border-white/40 transition duration-400 transform hover:scale-105 hover:border-[#ff00ff] cursor-pointer">
                <img className="w-full h-full object-cover rounded-2xl" src={P5} alt="" />
            </div>

            <div className="text-white h-[250px] w-[390px] rounded-2xl border-2 border-white/40 transition duration-400 transform hover:scale-105 hover:border-[#ff00ff] cursor-pointer">
                <img className="w-full h-full object-cover rounded-2xl" src={P7} alt="" />
            </div>
        </div>
