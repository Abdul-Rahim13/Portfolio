...
function Projects() {
  return (
    <div id="portfolio" className="bg-[#161513] py-12 px-4 md:px-12">
      {/* Heading */}
      <div className="flex flex-col items-center">
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-semibold text-white mt-10 text-center relative">
          My Latest Work
        </h1>
        <img
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 justify-items-center mt-10">
        {[P1, P2, P3, P4, P5, P7].map((image, idx) => (
          <div
            key={idx}
            className="text-white h-56 w-80 sm:h-60 sm:w-80 md:h-64 md:w-[380px] 
                       rounded-2xl border-2 border-white/40 transition duration-400 
                       transform hover:scale-105 hover:border-[#ff00ff] cursor-pointer"
          >
            <img
